  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled
          ? "border-b border-neon/[0.06] bg-background/90 backdrop-blur-md"
          : "bg-transparent"
      }`}
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <a
          ...
          className="hidden rounded-full bg-neon px-5 py-2 text-sm font-semibold text-background transition-all hover:shadow-[0_0_25px_rgba(200,255,0,0.4)] md:inline-flex"
        >
          Hire Me
        </a>
